...
Follow the instructions in [install maxtext](../install_maxtext) to install MaxText with post-training dependencies. We recommend installing from PyPI to ensure you have the latest stable versionset of dependencies.
